package com.bamboo.assur.partnerinsurers.registry.registry.presentation.controllers
...
import com.bamboo.assur.partnerinsurers.registry.registry.application.commands.handlers.ChangePartnerInsurerStatusCommandHandler
import com.bamboo.assur.partnerinsurers.registry.registry.application.commands.handlers.CreatePartnerInsurerCommandHandler
import com.bamboo.assur.partnerinsurers.registry.registry.application.commands.handlers.UpdatePartnerInsurerCommandHandler
import com.bamboo.assur.partnerinsurers.registry.registry.application.queries.GetPartnerInsurerByIdQuery
import com.bamboo.assur.partnerinsurers.registry.registry.application.queries.GetPartnerSummariesQuery
import com.bamboo.assur.partnerinsurers.registry.registry.application.queries.handlers.GetPartnerInsurerByIdQueryHandler
import com.bamboo.assur.partnerinsurers.registry.registry.application.queries.handlers.GetPartnerSummariesQueryHandler
import com.bamboo.assur.partnerinsurers.registry.registry.presentation.dtos.requests.ChangePartnerInsurerStatusRequestDto
import com.bamboo.assur.partnerinsurers.registry.registry.presentation.dtos.requests.CreatePartnerInsurerRequestDto
import com.bamboo.assur.partnerinsurers.registry.registry.presentation.dtos.requests.UpdatePartnerInsurerRequestDto
import com.bamboo.assur.partnerinsurers.registry.registry.presentation.dtos.responses.PartnerInsurerDetailResponseDto.Companion.toResponseDTO
